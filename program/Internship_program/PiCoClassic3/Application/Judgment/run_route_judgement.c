...
/*==============================================================================*/
int get_next_direction(int my_pos_x, int my_pos_y, int my_dir)
{
	...
	{
		if( (wall_info[my_pos_x][my_pos_y].north & MASK_SEARCH) == NO_WALL )
		{
	...
	{
		if( (wall_info[my_pos_x][my_pos_y].east & MASK_SEARCH) == NO_WALL )
		{
	...
	{
		if( (wall_info[my_pos_x][my_pos_y].west & MASK_SEARCH) == NO_WALL )
		{
	...
	{
		if( (wall_info[my_pos_x][my_pos_y].south & MASK_SEARCH) == NO_WALL )
		{
...
/*==============================================================================*/
int get_priority(int my_dir, int next_dir)
{	
...
/*==============================================================================*/
int judgement_next_run_mode(int next_direction, int my_dir)
{
	int next_run_mode;
